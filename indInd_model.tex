...
\notIncludedProof{ 
  ...
  \item Let $\kappa$ be a regular cardinal of cardinality greater than
    that of all index sets which starts an inductive argument. By the
    inaccessibility of $\cardz$, $\kappa < \cardz$, and by the
    standard argument (see e.g.\ \cite{aczel1977indDef}), a fixed
    point of $B^{\alpha}$ (and hence also of $A^{\alpha}$) is reached
    after $\kappa$ iterations.
